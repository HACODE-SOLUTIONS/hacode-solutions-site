    ...
    <>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          <div>
            ...
            <p className="text-lg text-gray-400 mb-6 leading-relaxed">
              HACODE SOLUTIONS provides <strong className="text-white font-medium">DevSpec files</strong> — structured
      ...
      <section className="container mx-auto px-4 py-24">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-medium mb-12 text-center">How to Use DevSpecs</h2>
          ...
          <div className="bg-brand-gray rounded border border-brand-border p-8">
            <h3 className="font-medium mb-4 text-sm">Works With Any AI Coding Tool</h3>
            <p className="text-gray-500 text-sm mb-6 leading-relaxed">
              DevSpecs are model-agnostic. Use them with Cursor, Claude Code, GitHub Copilot, ChatGPT, Gemini Code Assist, or any other LLM-powered coding assistant.
            </p>
